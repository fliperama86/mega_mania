| ---------------------------------------------------------------------------
| Ported verbatim from ~/Projects/references/SegaCDMode1PCM/kos.s
| MIT License, Copyright (c) 2023 Mikael Kalms
| Unpacks the CD Sub-CPU BIOS from the cart's BIOS ROM window into PRG RAM
| (see cd_init() in cd.c); the disc drive itself is never touched by this.
| ---------------------------------------------------------------------------
